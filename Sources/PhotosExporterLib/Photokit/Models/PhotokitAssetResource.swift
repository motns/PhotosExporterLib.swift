...
enum PhotokitAssetResourceType: Int, Sendable {
  ...
  static func fromPHAssetResourceType(type: PHAssetResourceType) -> PhotokitAssetResourceType {
    return switch type {
      ...
      case let t where t.rawValue == 110: PhotokitAssetResourceType.secondaryAdjustmentData
      // Same as above
      case let t where t.rawValue == 16: PhotokitAssetResourceType.adjustmentAAE
      @unknown default:
        fatalError("Unhandled PHAssetResourceType: \(type)")
    }
  }
...
struct PhotokitAssetResource: Sendable {
  ...
  var fileTypeOpt: FileType? {
    get {
      switch assetResourceType {
  ...
  static func fromPHAssetResource(
    ...
    return PhotokitAssetResource(
      ...
      assetResourceType: PhotokitAssetResourceType.fromPHAssetResourceType(type: resource.type),
